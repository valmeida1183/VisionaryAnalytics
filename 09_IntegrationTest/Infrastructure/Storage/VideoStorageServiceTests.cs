...
public class VideoStorageServiceTests : IDisposable
{
    ...
    [Fact]
    public void GetFFMpegBinaryFolderPath_ShouldReturnCorrectPath()
    {
        // Arrange
        var expectedPath = Path.Combine(
            _settings.Root,
        ...
        // Act
        var actualPath = _videoStorageService.GetFFMpegBinaryFolderPath();
        // Assert
        Assert.Equal(expectedPath, actualPath);
    }
